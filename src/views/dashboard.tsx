  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List> 
            <ListItem button onClick={findRecipe}>
            <ListItemIcon>
                <DashboardIcon />
            </ListItemIcon>
                <ListItemText primary="Find a recipe" />
            </ListItem>
            <ListItem button  onClick={displaySavedRecipes}>
            <ListItemIcon>
                <BarChartIcon />
            </ListItemIcon>
                <ListItemText primary="Your recipes" />
            </ListItem>
            <ListItem button onClick={displayUser}>
            <ListItemIcon>
                <PeopleIcon />
            </ListItemIcon>
